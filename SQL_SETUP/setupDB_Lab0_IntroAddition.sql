-- Insert Lab 0 + its test cases (idempotent upserts)
-- Run this after your normal DB init (it should NOT re-seed the whole schema).
...
-- 2) Test cases row(s)
-- Note: The emulator compares bytes in result_memory. SUM is expected at byte address 0x8.
